...
| <image src="images/jerrys_rover/rover_lawn_1.jpeg" height="175"> <image src="images/jerrys_rover/rover_oled_monitor.jpeg" height="175"> 
|:-:|
...
### Background
I always wanted to build an outdoor rover so I started building the JPL rover in May 2025. It took me a couple of months to build it but it was great fun. I learned a lot along the way especially after not using Loctite, the screws loosened and left me with a trail of nuts and bolts in the backyard. Next steps, clean up cabling and add all the panels.
### Modifications
